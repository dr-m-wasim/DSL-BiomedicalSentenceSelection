...
import pk.edu.kics.dsl.entity.CalculatedMeasures;
import pk.edu.kics.dsl.entity.ExactAnswer;
import pk.edu.kics.dsl.entity.Question;
import pk.edu.kics.dsl.entity.Snippet;
...
public class QuestionAnswerEvaluator {
    ...
    String question_id;
    int question_type;
    public Boolean is_triple=false; 
   ...
   public String  getQuestionID()
   {
    ...
    public void calculatePhaseBMeasuresForPair(Question golden,Question response)
    {
        ...
        {
            if(this.VERSION_OF_CHALLENGE == EvaluatorTaskB.BIOASQ2){
            ...
            else if(this.VERSION_OF_CHALLENGE==EvaluatorTaskB.BIOASQ3 || this.VERSION_OF_CHALLENGE==EvaluatorTaskB.BIOASQ5)
            {
    ...
    public void calculateAveragePrecision(ArrayList listGolden, ArrayList listResponses, CalculatedMeasures cm)
    {
	 ...
	 // we should divide with the size of the golden list
        ...
        //    check the guidlines **
         if(VERSION_OF_CHALLENGE==EvaluatorTaskB.BIOASQ2)
            cm.setAverage_precision(ap/(double)listGolden.size());
         else if(VERSION_OF_CHALLENGE==EvaluatorTaskB.BIOASQ3 || this.VERSION_OF_CHALLENGE==EvaluatorTaskB.BIOASQ5)
